...
function Bienestar() {
  ...
  return (
    ...
    <div className={style.container}>  
      ...
      Ofrecemos clases de Yoga que nos ayuda a relajarnos,a reducir el estrés, a mejorar nuestra concentración y nos ayuda a mejorar la confianza en uno mismo.Contamos con profesionales especializados en el tema. Nada mejor que iniciar el día con estas clases.</p>
