  ...
  return (
    ...
    <div className={style.body}>
      ...
      <div className={style.container}>  
        ...
        Somos un grupo de amigos de diferentes nacionalidades que nos conocimos en el bootcam de Henry y tuvimos la visión a nicios de este año realizar este proyecto desde un comienzo nos gustó la idea de elegir un lugar alejado de la ciudad  para construir este hotel en medio de la montaña. A ambos nos gusta rodearnos de la naturaleza y disfrutar de las vistas más impresionantes que pueda brindarnos la naturaleza. 
        Esa es la razón por la que nos unimos y pusimos en marcha este proyecto. De esta manera pensamos en juntarnos todos y fundar Eterno Hotel.</p>
      </div>
      <div className={style.container}>  
        <div className={style.centerleft}></div>  
        <p className={style.parrafo2}>
        Con el tiempo también nos gustaría implementar servicios adicionales como salas de meditación, yoga, masajes y caminatas por los alrededores de Eterno.  De esta manera, queremos ofrecer un lugar alejado, para quitarnos el extress que nos puede generar la vida en la ciudad y conectarse con uno mismo en familia, amigos o en pareja.</p>
